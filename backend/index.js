  ...
  "signals": [
    ...
    while (true) {
      try {
        ...
        if (apiError.message && apiError.message.includes("503")) {
          console.warn(`[Warning] Model unavailable (503 High Demand). Retrying in ${delay / 1000} seconds...`);
    ...
    try {
      ...
      if (!parsed.signals || !Array.isArray(parsed.signals)) {
        throw new Error("Parsed JSON does not contain the required 'signals' array.");
      }
